...
public class DedicatedServerProperties extends PropertyManager<DedicatedServerProperties> {
    ...
    // CraftBukkit start
    public static DedicatedServerProperties load(IRegistryCustom iregistrycustom, InputStream inputStream, OptionSet optionset) {
        return new DedicatedServerProperties(loadPropertiesFile(inputStream), iregistrycustom, optionset);
    }
